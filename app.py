...
# TODO(AutumnVulpes) - Functionalise preload initialisation
...
if uploaded_file is not None:
    ...
    # TODO(AutumnVulpes) - Functionalise column creation
    ...
    with right_col:
        ...
        # TODO(AutumnVulpes) - Functionalise conditional to better parse it
        if not filtered_df.empty and x_axis and y_axis and x_axis in filtered_df.columns and y_axis in filtered_df.columns:
            ...
            # TODO(AutumnVulpes) - Functionalise downloading as PNG
...
# TODO(AutumnVulpes) - Move this function (and any others you left above TO THE TOP OUTSIDE THE CONDITIONALS)
